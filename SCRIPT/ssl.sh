...
echo -e "\033[1;32m $(fun_trans  "INSTALADOR SSL By VPS-ARGENTO")"
msg -bar
...
echo -e "\033[1;33m $(fun_trans  "Ahora Necesitamos Saber Que Puerta del SSL, Va a Escuchar")"
msg -bar
    while true; do
...
echo -e "${cor[3]}INSTALADOR SSL By VPS-ARGENTO"
msg -bar
echo -e "${cor[1]} Escoja la opcion deseada."
msg -bar
echo "1).- INICIAR O DETENER SSL"
