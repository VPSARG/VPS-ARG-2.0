...
clear
msg -bar2
echo -e "\033[1;93m     AGREGADOR DE DNS PERSONALES By @VPS_ARGENTO_BOT "
msg -bar2
...
echo -e "\033[1;39m Se debera agregar en la aplicacion a usar estos DNS."
echo -e "\033[1;39m En APPS como SS,SSR,V2RAY no es necesario agregarlos."
msg -bar2
echo -e "\033[1;93m Recuerde escojer entre 1 DNS ya sea el de USA,BR,MX,CA \n segun le entrego el BOT."
echo ""
