...
screen -dmS getpy python ${SCPinst}/PGet.py -b "0.0.0.0:$1" -p "${SCPinst}/pwd.pwd"
 ...
 msg -bar
 echo -ne "$(fun_trans  "Su Contraseña Gettunel e"):"
 echo -e "\033[1;32m ARG-VPS"
 msg -bar
...
echo -e "\033[1;32m $(fun_trans  "INSTALADOR SOCKS 🇦🇷 VPS-ARGENTO 🇦🇷 ")"
msg -bar
...
echo -e "$(fun_trans  "Introduzca un Mini-Banner")"
msg -bar
