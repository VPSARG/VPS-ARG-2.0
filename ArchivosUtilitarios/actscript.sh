...
function_verify () {
  ...
  echo "OK-OFF-Vps-Arg" > /usr/bin/lickal &>/dev/null
...
wget -O /bin/monitor.sh https://raw.githubusercontent.com/VPSARG/VPS-ARG-2.0/master/ArchivosUtilitarios/Monitor-Service/monitor.sh &> /dev/null
...
clear
msg -bar2
echo -e "\e[97m\033[1;41m       •°•°•°• 🇦🇷 = PANEL | ARGENTO = 🇦🇷 •°•°•°•       \033[1;37m"
msg -bar2
[[ $1 = "" ]] && funcao_idioma || {
[[ ${#1} -gt 2 ]] && funcao_idioma || id="$1"
 }
error_fun () {
msg -bar2 && msg -verm "$(source trans -b es:${id} "La Key Es de Otro Servidor Por Lo Tanto Fue Excluida"|sed -e 's/[^a-z -]//ig') " && msg -bar2
...
if [[ -e $HOME/lista-arq ]] && [[ ! $(cat $HOME/lista-arq|grep "KEY INVALIDA!") ]]; then
   msg -bar2
   msg -verd "$(source trans -b es:${id} " INSTALANDO"|sed -e 's/[^a-z -]//ig'): \033[1;31m[MOD By VPS-ARGENTO]"
